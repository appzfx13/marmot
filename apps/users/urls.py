...
urlpatterns = [
    ...
    path('dashboard/live-mock/', UserLiveMockDashboardView.as_view(), name='user-live-mock-dashboard'),
    ...
    path('strategy-check/', UserStrategyCheckView.as_view(), name='user-strategy-check'),
