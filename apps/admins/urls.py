...
from .views import (
    ...
    AdminLiveMacroRibbonView,
    AdminLiveOptionChainPartialView,
    AdminLivePositionsPartialView,
    AdminLiveHoldingsPartialView,
    AdminLiveOrdersPartialView,
    AdminLiveOrderCancelView,
    AdminLivePositionSquareOffView,
    AdminSandboxDashboardView,
    AdminSandboxPositionsPartialView,
    AdminSandboxPositionSquareOffView,
    AdminSandboxOrdersPartialView,
    AdminSandboxOrderCancelView,
...
urlpatterns = [
    ...
    path('dashboard/live/macro-ribbon/', AdminLiveMacroRibbonView.as_view(), name='admin-live-macro-ribbon'),
    path('dashboard/live/option-chain/', AdminLiveOptionChainPartialView.as_view(), name='admin-live-option-chain'),
    path('dashboard/live/positions/', AdminLivePositionsPartialView.as_view(), name='admin-live-positions-partial'),
    path('dashboard/live/holdings/', AdminLiveHoldingsPartialView.as_view(), name='admin-live-holdings-partial'),
    path('dashboard/live/orders/', AdminLiveOrdersPartialView.as_view(), name='admin-live-orders-partial'),
    ...
    path('dashboard/sandbox/positions/', AdminSandboxPositionsPartialView.as_view(), name='admin-sandbox-positions-partial'),
    path('dashboard/sandbox/positions/square-off/', AdminSandboxPositionSquareOffView.as_view(), name='admin-sandbox-position-square-off'),
    path('dashboard/sandbox/orders/', AdminSandboxOrdersPartialView.as_view(), name='admin-sandbox-orders-partial'),
    path('dashboard/sandbox/orders/<str:order_id>/cancel/', AdminSandboxOrderCancelView.as_view(), name='admin-sandbox-order-cancel'),
